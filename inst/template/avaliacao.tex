...
\usepackage{a4wide,color,verbatim,url,xargs,fancyvrb,graphicx}
\usepackage{fancyhdr}
\usepackage{float}
\usepackage{amsthm}       
...
\fancyfoot[R]{\textbf{``Todas as grandes coisas s{\~a}o simples. E muitas podem ser expressas numa s{\'o} palavra: liberdade; justi{\c c}a; honra; dever; piedade; esperan{\c c}a''} - \textit{Winston Churchill}}
\cfoot{}
%++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++%

\section*{}
\textbf{Unidade Acad{\^e}mica:} \input{unid}\\
\textbf{Classe:} \input{disc}\\
\textbf{Carga Hor{\'a}ria:}\input{carg} \textbf{Per{\'i}odo Letivo:} \input{anol}\\
...
\textbf{Recomenda{\c c}{\~o}es: Leia atentamente todas as quest{\~o}es antes de respond{\^e}-las. Come{\c c}e respondendo as quest{\~o}es mais f{\'a}ceis. N{\~a}o utilize meios il{\'i}citos para responder as quest{\~o}es pois o {\'u}nico prejudicado ser{\'a} voc{\^e}. Boa prova!!!}\vspace{0.5cm}

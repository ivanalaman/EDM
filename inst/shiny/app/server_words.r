...
output$esdisc        <- renderText({ tr("esdisc")    })
output$conass        <- renderText({ tr("conass")    })
...
output$headaval      <- renderText({ tr("headaval")     })
output$headunid      <- renderText({ tr("headunid")     })
output$headdisc      <- renderText({ tr("headdisc")     })
output$headchor      <- renderText({ tr("headchor")     })
output$mgatuaapp     <- renderText({ tr("mgatuaapp")    })
